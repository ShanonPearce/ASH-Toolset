...
def main():
    ...
    #acoustic space
    ac_space_default=CN.AC_SPACE_LIST_GUI[1]
    ...
    sub_response_default=CN.SUB_RESPONSE_LIST_GUI[0]
    ...
    try:
        ...
        if __version__ == version_loaded:
            ...
            show_hpcf_history_loaded=ast.literal_eval(config['DEFAULT']['show_hpcf_history'])
            ...
            e_apo_prevent_clip_loaded=(config['DEFAULT']['prevent_clip'])
            ...
            crossover_f_mode_loaded=config['DEFAULT']['crossover_f_mode']
            crossover_f_loaded=int(config['DEFAULT']['crossover_f'])
            sub_response_loaded=config['DEFAULT']['sub_response']
            hp_rolloff_comp_loaded=ast.literal_eval(config['DEFAULT']['hp_rolloff_comp'])
            fb_filtering_loaded=ast.literal_eval(config['DEFAULT']['fb_filtering'])
            
        else:
            if CN.LOG_INFO == True:
                logging.info('Settings not loaded due to version mismatch')
            if __version__ == '3.2.0':#if running v3.2.0 for the first time, delete old npy hrtf datasets so that new ones can be created
                directory= CN.DATA_DIR_HRIR_NPY_HL
                hf.delete_all_files_in_directory(directory, verbose=True, gui_logger=None)
                directory= CN.DATA_DIR_HRIR_NPY_USER
                hf.delete_all_files_in_directory(directory, verbose=True, gui_logger=None)
                directory= CN.DATA_DIR_HRIR_NPY_DH_V
                hf.delete_all_files_in_directory(directory, verbose=True, gui_logger=None)
        ...
        with dpg.tab_bar(tag='tab_bar'):
            ...
            with dpg.tab(label="Quick Configuration",tag='quick_config', parent="tab_bar"): 
                ...
                with dpg.group(horizontal=True):
                    ...
                    with dpg.group():    
                        ...
                        with dpg.child_window(autosize_x=True, height=440):
                    ...
                    with dpg.group(horizontal=True):
                        with dpg.group():
                            ...
                            with dpg.child_window(width=300, height=110):
                                ...
                                dpg.add_button(label="Click Here to Regenerate",user_data="",tag="brir_reverb_tag", callback=cb.generate_brir_reverb)
                                ...
                                dpg.add_button(label="Click Here to Regenerate",user_data="",tag="hrir_dataset_tag", callback=cb.generate_hrir_dataset)
                            ...
                            with dpg.child_window(width=300, height=60):
                                ...
                                dpg.add_button(label="Click Here to Rebuild",user_data="",tag="hpcf_db_create", callback=cb.create_db_from_wav)
                            ...
                            with dpg.child_window(width=300, height=60):
                                ...
                                dpg.add_button(label="Click Here to Print",user_data="",tag="hpcf_print_summary_tag", callback=cb.print_summary)
                        with dpg.group():
                            ...
                            with dpg.child_window(width=340, height=120):
                                with dpg.group(horizontal=True):
                                    with dpg.group():
                                        ...
                                        dpg.add_button(label="Click Here to Calculate",user_data="",tag="hpcf_average_tag", callback=cb.calc_hpcf_averages)
                                        ...
                                        dpg.add_button(label="Click Here to Renumber",user_data="",tag="hpcf_renumber_tag", callback=cb.renumber_hpcf_samples)
                                    ...
                                    with dpg.group():
                                        ...
                                        dpg.add_button(label="Click Here to Calculate",user_data="",tag="hpcf_variant_tag", callback=cb.calc_hpcf_variants)
                                        dpg.add_text("Crop All HpCFs")
                                        dpg.add_button(label="Click Here to Crop",user_data="",tag="hpcf_crop_tag", callback=cb.crop_hpcfs)
                            #Section for HpCFs
                            with dpg.child_window(width=340, height=180):
                                ...
                                dpg.add_button(label="Click Here to Generate",user_data="",tag="hpcf_summary_tag", callback=cb.generate_hpcf_summary)
                                ...
                                dpg.add_button(label="Click Here to Calculate",user_data="",tag="hpcf_new_calc_tag", callback=cb.calc_new_hpcfs) 
                        ...
                        with dpg.group():
                            ...
                            with dpg.child_window(width=280, height=120):
                                ...
                                dpg.add_button(label="Click Here to Delete",user_data="",tag="hpcf_delete_hp_tag", callback=cb.delete_hp)
                                dpg.add_text("Delete Sample from DB (selected sample)")
                                dpg.add_button(label="Click Here to Delete",user_data="",tag="hpcf_delete_sample_tag", callback=cb.delete_sample)
                            ...
                            with dpg.child_window(width=280, height=180):
                                ...
                                dpg.add_button(label="Click Here to Rename",user_data="",tag="hpcf_rename_hp_tag", callback=cb.rename_hp_hp)
                                ...
                                dpg.add_button(label="Click Here to Rename",user_data="",tag="hpcf_rename_sample_tag", callback=cb.rename_hp_sample)
                            ...
                            with dpg.group(horizontal=True):
                                ...
                                with dpg.child_window(width=420, height=120):
                                    with dpg.group(horizontal=True):
                                        ...
                                        with dpg.group():
                                            ...
                                            dpg.add_button(label="Click Here to Rename",user_data="",tag="bulk_rename_sample_tag", callback=cb.bulk_rename_sample)
                                ...
                                with dpg.child_window(width=200, height=120):
                                    with dpg.group():
                                        ...
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="mono_cue_tag", callback=cb.run_mono_cue)
                                        dpg.add_text("Mono Cue Processing (HP)")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="mono_cue_hp_tag", callback=cb.run_mono_cue_hp)
                            ...
                            with dpg.child_window(width=720, height=180):
                                ...
                                with dpg.group(horizontal=True):
                                    with dpg.group():
                                        ...
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="raw_air_to_dataset_tag", callback=cb.run_raw_air_to_dataset)
                                    dpg.add_text("  ")
                                    with dpg.group():
                                        dpg.add_text("AIR to BRIR Estimation")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="air_to_brir_tag", callback=cb.run_air_to_brir)
                                    dpg.add_text("  ")
                                    with dpg.group():
                                        dpg.add_text("Raw BRIR Compensation")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="raw_brir_comp_tag", callback=cb.run_raw_to_brir)
                                    dpg.add_text("  ")
                                    with dpg.group():
                                        dpg.add_text("Raw AIR extraction")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="air_extraction_tag", callback=cb.run_extract_airs)
                                    dpg.add_text("  ")
                                    with dpg.group():
                                        dpg.add_text("Split AIRs to Set")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="split_air_set_tag", callback=cb.run_split_airs_to_set)
                                    dpg.add_text("  ")
                                with dpg.group(horizontal=True):
                                    with dpg.group():
                                        dpg.add_text("Calculate reverb target resp.")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="calc_reverb_target_tag", callback=cb.calc_reverb_target)
                                    dpg.add_text("  ")
                                    with dpg.group():
                                        dpg.add_text("Sub BRIR Generation")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="calc_sub_brir_tag", callback=cb.run_sub_brir_calc)
                                    dpg.add_text("  ")
                                    with dpg.group():
                                        dpg.add_text("Generate room target set")
                                        dpg.add_button(label="Click Here to Run",user_data="",tag="calc_room_target_tag", callback=cb.run_room_target_calc)
            ...
            with dpg.tab(label="Additional Tools & Settings",tag='additional_tools', parent="tab_bar"):    
                ...
                with dpg.child_window(width=1690, height=482, tag="console_window",user_data=None):
                    dpg.add_text("Log",tag='log_text',user_data=__version__)
                    dpg.bind_item_font(dpg.last_item(), bold_font)
